...
class NavBar extends Component {
  ...
  render() {
    return (
      <React.Fragment>
        <nav className="navbar fixed-top navbar-dark zeroOpacity">
          <a className="navbar-brand" href="#">
            <svg
              ...
              height="64"
            >
              <path d="M16 48 L20 22 L40 48 L38 16 L38 40 L16 16 Z" />
            </svg>
          </a>
          <div className="">
        ...
        <div className="emailcontainer">
          <div>
            <div className="emailwrapper fade-enter-done">
              <a href="mailto:nitheeshmashraf@live.com" className="emaillink">
                nitheeshmashraf@live.com
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="iconcontainer">
          <div>
            <ul className="iconwrapper fade-enter-done">
              <li className="">
                <a
                  href="https://github.com/nitheeshmashraf/"
                  target="_blank"
              ...
              <li className="k">
                <a
                  href="https://www.linkedin.com/in/nitheeshmashraf/"
                  target="_blank"
                  rel="nofollow noopener noreferrer"
                  aria-label="Linkedin"
                  className="icons"
              ...
              <li className="k">
                <a
                  href="https://www.instagram.com/nitheeshmashraf/"
                  target="_blank"
                  rel="nofollow noopener noreferrer"
              ...
              <li className="k">
                <a
                  href="https://twitter.com/nitheeshmashraf"
                  target="_blank"
                  rel="nofollow noopener noreferrer"
                  aria-label="Twitter"
                  className="icons"
